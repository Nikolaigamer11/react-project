...
import { signOut } from 'firebase/auth'; // Importing the signOut method from Firebase authentication
import { auth } from '../firebaseConfig'; // Importing the auth object from the Firebase configuration file
import { useState, useEffect } from 'react'; // Importing useState and useEffect hooks from React
import { onAuthStateChanged } from 'firebase/auth'; // Importing the onAuthStateChanged method from Firebase authentication
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md text-center">
        ...
        <p className="mb-6">Are you sure you want to log out?</p> {/* Confirmation message */}
        <button
